...
function draw_tree(error, treeData) {
    ...
    // size of the diagram
    var viewerWidth = $(document).innerWidth()*0.8;
    var viewerHeight = $(document).innerHeight()*0.9;
